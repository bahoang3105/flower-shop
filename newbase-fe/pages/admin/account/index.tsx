...
import {
  useDeleteAccountGuests,
  useGetAccountGuests,
} from "hooks/accountGuest";
  ...
  return (
    <div className="account-guest">
      ...
      <Modal
        ...
        title="Xóa bản ghi tài khoản khách"
        footer={null}
      >
        <div className="modal-account-content">
          Bạn có chắc chắn muốn{" "}
          <span>xóa&nbsp;{checkList.length} bản ghi tài khoản khách</span> hay
          không?
        </div>
