              ...
              <div className="create-flower-form__thumbnail">
                {!thumbnail && (
                  <>
                    ...
                    />
                    <p>
                      Tải lên <strong>JPG, JPEG, PNG, GIF</strong> file. Kích
                      thước tối đa&nbsp;
                ...
                {thumbnail ? (
                  <div
                    className="create-flower-form__thumbnail__preview"
                    onClick={click}
                  >
          ...
          <section>
            ...
            <div className="create-flower-preview__border">
              <div className="create-flower-preview__image">
                ...
                {thumbnail ? (
                  <AntdImage
                    rootClassName="create-flower-preview__image__img"
                  ...
                  <div className="create-flower-preview__image__default">
                    <AntdImage
                      src={ImageSvg.previewImage}
                      height={37}
                      width={64}
                      preview={false}
                    />
                    <div className="create-flower-preview__image__notice">
                      Hãy tải ảnh đại diện để xem trước
                    </div>
                  </div>
                )}
              </div>
              <div className="create-flower-preview__name">{name}</div>
              <div className="create-flower-preview__price">
                {price && formatNumber(price) + " VND"}
              </div>
            </div>
          </section>
        </Col>
